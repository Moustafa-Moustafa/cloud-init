...
def report_event(event, excluded_handlers={}):
    """Report an event to all registered event handlers except the excluded_handlers.
    ...
    :param event_type:
        ...
        reporting module.
    """
    for handler_key, handler in instantiated_handler_registry.registered_items.items():
